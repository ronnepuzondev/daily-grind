...
export default function MyJournalsPage({ user }) {
  ...
  // to display journals tied to logged in user's ID
  useEffect(() => {
    axios
  ...
  const deleteJournal = (id) => {
    axios.delete(`/journals/${id}`).catch((err) => console.log(err));
  ...
  return (
    ...
    >
      <div style={{ width: "90%", margin: "auto auto", textAlign: "center" }}>
        ...
        <Link style={{ color: "white" }} to="/journals/new">
          Add Journal Entry
        </Link>
